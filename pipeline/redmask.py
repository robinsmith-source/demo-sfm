...
One-off preprocessing helper for the hdm dataset (not part of the automated
reconstruction pipeline). Requires Pillow: `uv run --with pillow pipeline/redmask.py <images...>`
"""
import sys
